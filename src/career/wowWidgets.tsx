...
function BumpChart({ data }: { data: RankHistory }) {
  ...
  const H = 128
  const W = Math.max(width, 320), padL = 18, padR = 104, padT = 20, padB = 26
  ...
  const overtake = useMemo(() => computeStrongestOvertake(data, xOf, yOf), [data, W]) // eslint-disable-line react-hooks/exhaustive-deps
